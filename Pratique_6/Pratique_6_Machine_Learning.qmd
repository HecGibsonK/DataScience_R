...
Mydata_New <- subset(Mydata, select = c(Survived,Pclass,Sex,Age,SibSp,Parch,Fare)) # Sélectionner et/ou supprimer des colonnes d'une table
...
```{r}
anova(model_logistique2, test = "Chisq")
```
...
# [**Prédiction sur une nouvelle base**]{.underline}
